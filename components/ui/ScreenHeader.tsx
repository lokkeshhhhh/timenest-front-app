  ...
  return (
    ...
    >
      <TouchableOpacity
        onPress={() => router.back()}
        hitSlop={12}
        className="w-9 h-9 rounded-icon bg-surfaceGray dark:bg-surfaceGrayDark items-center justify-center mr-3"
      >
        <FontAwesome name="angle-left" size={20} color={colors.textOnSurface} />
      </TouchableOpacity>
